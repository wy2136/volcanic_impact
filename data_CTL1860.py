...
dirin = '/tigress/wenchang/MODEL_OUT/CTL1860_noleap_tigercpu_intelmpi_18_576PE/POSTP'
year_shift = 1859
...
def open_ensemble(data_name, nctag='atmos_month', ens=None, year_start_ens1=11, n_years=5, year_volcano=1963):
    if ens is None:
        ens = ens_default
    das = []
    for en in ens:
